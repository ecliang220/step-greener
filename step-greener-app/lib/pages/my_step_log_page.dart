...
class StepLogPageState extends State<MyStepLogPage> {
  ...
  void _selectDay(int day) {
    setState(() {
      _selectedDay = day; // Update selected day when clicking a date
    });
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Ensures the GridView takes only necessary space and doesn't freeze the app
          Expanded(
          ...
          if (_selectedDay != null)
            Container( 
              ...
              height: 200, // Ensures the StepDisplay is visible
